...
export const portfolio = {
  ...
  socials: { github:"https://github.com/rakamahendra", linkedin:"https://linkedin.com/in/rakamahendra", email:"mailto:raka@example.com" },
  contact: { email:"raka@example.com", response:"Biasanya membalas dalam 1–2 hari kerja." },
  experience: [
  ...
  testimonials: [
    {name:"Dian Pramesti", title:"Product Director", quote:"Raka punya rasa desain yang jarang dimiliki engineer. Ia bisa mengubah kebutuhan yang masih mentah menjadi antarmuka yang tenang dan jelas."},
